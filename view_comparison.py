...
""")
    ...
    fig = build_fund_chart(inputs, res, _show_ref_line)
    ...
    st.page_link(st.session_state["_pages"]["market"], label="**See what happens when the market has good years and bad years →**", icon="🎢")
